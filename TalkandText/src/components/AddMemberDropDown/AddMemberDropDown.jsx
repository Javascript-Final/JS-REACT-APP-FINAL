...
import { addMember, getTeamsByUserUid } from '../../services/teams-services';

export const AddMemberDrownDown = ({ open, anchorEl, handleClose }) => {
    ...
    const addToTeam = async () => {
        ...
        await addMember(userName, teamNames);
        navigate('/')
